...
if __name__ == "__main__":
    # --- Configuration ---
    TOTAL_ITERATIONS = 10
    DECKS_PER_ITERATION = 2000000
    BATCH_SIZE = 10000
    OUTPUT_DIR = "./data/decks"
    CSV_FILENAME = 'r_ON_r_performance_stats.csv'
    ...
    with open(CSV_FILENAME, 'w', newline='') as csvfile:
        ...
        for i in range(1, TOTAL_ITERATIONS + 1):
            ...
            PROCESS.cpu_percent(interval=None) # Initialize CPU usage calculation
            ...
            # --- Helper to count exported files ---
